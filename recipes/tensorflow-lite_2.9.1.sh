...
## Get Tensorflow Code ##
echo "git clone -b $SRCBRANCH https://github.com/nxp-imx/tensorflow-imx.git ${S}"
...
# cp --no-preserve=ownership -d ${B}/libtensorflow-lite.so.${PV} ${D}${libdir}/libtensorflow-lite.so
...
ls ${B}/tflite_pip/dist/
cp ${B}/tflite_pip/dist/tflite_runtime-*-linux_aarch64.whl ${D}/
# # Install pip package
