...
INFERENCE_SIZE = (256, 320)  # Model's expected input size

model_path = "scdepthv3.tflite"
...
def on_frame(sink, appsrc, interpreter, input_details, output_details, input_size, scale, zero_point):
